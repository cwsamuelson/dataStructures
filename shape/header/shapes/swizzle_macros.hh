...
#define Swiz2Types(x, y, X, Y, Vec) \
  Swiz2Type(Vec, X##Y##2, x, y);

#define Swiz2MemberRemap(x, y, X, Y) \
  SwizMember(X##Y##2, x##y)

#define Swiz2All \
  Swiz2Combo(Swiz2Types, vec2) \
  Swiz2Combo(Swiz2MemberRemap)
...
#define Swiz3Types(x, y, z, X, Y, Z, Vec) \
  Swiz3Type(Vec, X##Y##Z##2, x, y, z);

#define Swiz3MemberRemap(x, y, z, X, Y, Z) \
  SwizMember(X##Y##Z##2, x##y##z)

#define Swiz3All \
  Swiz3Combo(Swiz3Types, vec3) \
  Swiz3Combo(Swiz3MemberRemap)
...
#define Swiz4Types(x, y, z, w, X, Y, Z, W, Vec) \
  Swiz4Type(Vec, X##Y##Z##W##2, x, y, z, w);

#define Swiz4MemberRemap(x, y, z, w, X, Y, Z, W) \
  SwizMember(X##Y##Z##W##2, x##y##z##w)

#define Swiz4All \
  Swiz4Combo(Swiz4Types, vec4) \
  Swiz4Combo(Swiz4MemberRemap)
