...
equation equation::variable::derive(string var) const {
...
equation equation::constant::derive(string var) const {
  (void) var;
...
equation equation::multiplication::derive(string var) const {
...
equation equation::division::derive(string var) const {
...
equation equation::addition::derive(string var) const {
...
equation equation::subtraction::derive(string var) const {
  return lhs->derive(var) - rhs->derive(var);
}
...
equation equation::inversion::derive(string var) const {
...
equation equation::exponentiation::derive(string var) const {
  if(use_power) {
...
equation equation::logarithm::derive(string var) const {
  (void) var;
...
equation equation::operator*(double d) const {
...
equation equation::derive(string var, unsigned long long order) const {
...
equation gsw::operator ""_evar(long double value) {
  auto var = make_shared<equation::constant>();
  var->value = value;
  return { var };
}
