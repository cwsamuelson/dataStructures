  ...
  SECTION("Construct from any") {
    ...
    SECTION("'unsigned integer' type") {
      ...
      SECTION("unsigned long long"){
        ...
        SECTION("direct initialized") {
          gsw::json j((unsigned long long) 5);
