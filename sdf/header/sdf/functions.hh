...
fvec3 calcNormal(const fvec3 p, Func&& func) noexcept {
  ...
  return normalize(fvec3(func(p + h("xyy"_swz)) - func(p - h("xyy"_swz)),
...
fvec3 calcNormal(const fvec3 p, Func&& func) noexcept {
  ...
  return normalize(func("xyy"_swz) * func(p + k("xyy"_swz) * h) + 
...
fvec3 getNormal(const fvec2 p, Func&& func) {
  ...
  return normalize(fvec3(func(p - h("xy"_swz)) - func(p + h("xy"_swz)),
                         2.0 * h.x,
