...
TEST_CASE("", "[hp]") {
  ...
  SECTION("Division") {
    ...
    vector<gsw::high_polynomial::storage_type::value_type> vec1{{{ 0, 0, 0 }, -5 },
                                                                {{ 1, 0, 0 }, 1 }};
    vector<gsw::high_polynomial::storage_type::value_type> vec2{{{ 0, 0, 0 }, -2 },
                                                                {{ 1, 0, 0 }, 1 }};
    vector<gsw::high_polynomial::storage_type::value_type> vec3{{{ 0, 0, 0 }, 10 },
                                                                {{ 1, 0, 0 }, -7 },
                                                                {{ 2, 0, 0 }, 1 }};
    gsw::high_polynomial eq1(vec1.begin(), vec1.end());
    gsw::high_polynomial eq2(vec2.begin(), vec2.end());
